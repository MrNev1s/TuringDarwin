# TuringProbe 0.2.0 — source design review
...
0.2.0 introduces one short-lived BAR0 mapping only when both `-tdprobe` and
...
that review may a separate test EFI be prepared, and the first 0.2.0 boot must
