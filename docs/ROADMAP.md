...
| 0.2.1 | BAR0 read-only map and three-register whitelist | Source implemented; build/binary/live gates pending |
| 0.2.x | Expand only proven read-only identification telemetry | Blocked on 0.2.1 hardware result |
...
The next authorised action is only to build and audit 0.2.1. No MMIO write,
