...
/usr/bin/grep -E 'TuringProbe|TPMMIO|TPBAR0|TPCommand|TPBusMaster|TPHostMemory|TPHostPhysical'   "$OUT/ioreg-TuringProbe.txt" > "$OUT/ioreg-TuringProbe-focused.txt" 2>&1 || true
