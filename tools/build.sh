...

{
  ...
  echo "turingprobe_version=0.6.0"
  ...
  echo "offline_validation=golden-vectors;mmu-model;page-table-images;address-space;transaction-rollback;host-memory-model;host-memory-kext-contract"
